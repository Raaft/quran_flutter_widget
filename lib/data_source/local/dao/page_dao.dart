...
abstract class PageDao {
  ...
  @Query(
      'SELECT  DISTINCT(Page.id), Page.* FROM Page,ChaptersPage WHERE narration = :narrationId and ChaptersPage.chapterId = :chapterid and book = :bookId and ChaptersPage.pageId = Page.id')
